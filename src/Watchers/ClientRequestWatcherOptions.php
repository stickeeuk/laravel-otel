...
final class ClientRequestWatcherOptions extends WatcherOptions
{
    /**
    ...
    public function __construct(
        public readonly bool $record_errors = true,
        public readonly array $record_errors_except_statuses = [],
    ) {
    }
